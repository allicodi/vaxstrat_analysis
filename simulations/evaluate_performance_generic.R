...
for(fname in files){
  ...
  for(i in 1:nrow(grid)){
    ...
    result_df <- data.frame(
      ...
      estimand = c(rep("nat_inf",8),
                   rep("doomed",3),
                   rep("pop",3)),
      method = c(c("gcomp", "ipw", "aipw_CW", "tmle"),
                 c("gcomp_ER", "ipw_ER", "aipw_ER", "aipw_ER_CW"),
                 c("gcomp", "ipw", "aipw"),
                 c("gcomp", "ipw", "aipw")),
      ...
      # Truth
      additive_truth = c(rep(truth$effect_nat_inf[truth$doomed_inflation == grid$doomed_inflation[i] & truth$protected_epsilon == grid$protected_epsilon[i] & truth$doomed_epsilon == grid$doomed_epsilon[i] & truth$immune_epsilon == grid$immune_epsilon[i]], 8), 
      ...
      mult_truth = c(rep(truth$effect_nat_inf_mult[truth$doomed_inflation == grid$doomed_inflation[i] & truth$protected_epsilon == grid$protected_epsilon[i] & truth$doomed_epsilon == grid$doomed_epsilon[i] & truth$immune_epsilon == grid$immune_epsilon[i]], 8),
      ...
      psi_1_truth = c(rep(truth$E_Y1__protected_or_doomed[truth$doomed_inflation == grid$doomed_inflation[i] & truth$protected_epsilon == grid$protected_epsilon[i] & truth$doomed_epsilon == grid$doomed_epsilon[i] & truth$immune_epsilon == grid$immune_epsilon[i]], 8), 
      ...
      psi_0_truth = c(rep(truth$E_Y0__protected_or_doomed[truth$doomed_inflation == grid$doomed_inflation[i] & truth$protected_epsilon == grid$protected_epsilon[i] & truth$doomed_epsilon == grid$doomed_epsilon[i] & truth$immune_epsilon == grid$immune_epsilon[i]], 8), 
